...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">{{ __('Edit Role and Permissions') }}</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
        ...
        <section class="section">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{ __('Edit Role and Permissions') }}</h5>

                    <form method="POST" action="{{ url('dashboard/update-role') }}">
                        @csrf
                        <input type="text" id="id" name="id" value="{{ $role->id }}" readonly required
                            hidden />
